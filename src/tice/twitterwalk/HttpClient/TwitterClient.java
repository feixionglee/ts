...
import tice.twitterwalk.DB.DBImagesHelper;
import tice.twitterwalk.HttpClient.TwitterClient.DownloadPool.DownloadPiece;
import tice.twitterwalk.Util.Base64;
import tice.twitterwalk.Util.TweetsData;
import tice.twitterwalk.Util.TweetsDataDecoder;
...
//			SwapBitmap.compress(Bitmap.CompressFormat.JPEG, 100, output);
 	...
 	synchronized public void SaveIcon(String name, byte[] date){
 		if (_App._DbHelper == null) return;
 		_App._DbHelper.InsertImage(name, date);	
    }
